...
export function Todos() {
  ...
  async function toggleCompleted(todoId: number) {
    try {
      const [selectedtodo] = todos.filter((n) => n.todoId === todoId);
      const todoStatus = !selectedtodo.isCompleted;
      ...
      const updatedTodos = todos.map((n) =>
        n.todoId === updatedTodo.todoId ? updatedTodo : n
      );
